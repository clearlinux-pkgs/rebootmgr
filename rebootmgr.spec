...
Version  : 2.0
Release  : 6
URL      : https://github.com/SUSE/rebootmgr/releases/download/v2.0/rebootmgr-2.0.tar.xz
Source0  : https://github.com/SUSE/rebootmgr/releases/download/v2.0/rebootmgr-2.0.tar.xz
...
%prep
%setup -q -n rebootmgr-2.0
cd %{_builddir}/rebootmgr-2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672199129
